...
#   endif
      ...
      public:
        ...
        /// from has changed.
        ///
        /// This drops only this clip's cached sets. It does not reach the effects
        /// downstream of this one, whose input clips have cached what this effect
...
#     endif
      ...
      protected :
        /// Override this to populate 'metadata' with the metadata this clip carries for
        /// the image at 'time'. The default implementation adds nothing, so a host must
        /// override this to supply the metadata a clip carries, typically that of whatever
        /// an input clip is connected to.
